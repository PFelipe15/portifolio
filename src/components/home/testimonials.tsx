...
const TestimonialsSection = () => {
  ...
  return (
    <section className="w-screen h-[70vh] bg-red-200 mt-16 text-black min-h-[70vh] rounded-tl-[750px] p-8">
      <motion.div
      ...
      <motion.div
        ...
        className="flex items-center justify-center container gap-8"
      >
